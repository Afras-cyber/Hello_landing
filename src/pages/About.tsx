...
const About = () => {
  const { data: pageContent, isLoading } = usePageContent('meista');
  ...
  const heroTitle = getPageContent(pageContent, 'hero_title', 'Meistä');
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Tietoa Blondifysta. Opi lisää meidän arvoistamme ja toiminnastamme." />
      </Helmet>
